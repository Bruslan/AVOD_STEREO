...
class KittiDataset:
    ...
    @property
    def rgb_image_dir2(self):
        return self.image_dir2
    ...
    def _set_up_directories(self):
        ...
        self.image_dir2 = self._data_split_dir + '/image_' + str(self._cam_idx2)
    ...
    def get_rgb_image_path2(self, sample_name):
        return self.rgb_image_dir2 + '/' + sample_name + '.png'
    ...
    def load_samples(self, indices):
        ...
        for sample_idx in indices:
            ...
            cv_bgr_image2 = cv2.imread(self.get_rgb_image_path2(
                sample_name))
            rgb_image2 = cv_bgr_image2[..., :: -1]
            image_shape2 = rgb_image2.shape[0:2]
            image_input2 = rgb_image2
            ...
            if kitti_aug.AUG_PCA_JITTER in sample.augs:
                image_input[:, :, 0:3] = kitti_aug.apply_pca_jitter(
                    image_input[:, :, 0:3])
                image_input2[:, :, 0:3] = kitti_aug.apply_pca_jitter(
                    image_input2[:, :, 0:3])
            ...
            sample_dict = {
                ...
                constants.KEY_IMAGE_INPUT2: image_input2,
